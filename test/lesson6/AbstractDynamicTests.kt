...
Наследник всех своих родных.
        ...
        assertEquals("aaaaaa", longestCommonSubSequence("aaaAAAaaa", "aaaaaaaaa"))
        assertEquals("!@_=", longestCommonSubSequence("!@#$%^&*()_=+", "!@jhfdf_="))
    }
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(1), longestIncreasingSubSequence(listOf(1, 1, 1)))
        assertEquals(listOf(-7, -6, -5), longestIncreasingSubSequence(listOf(-7, -6, -5)))
        assertEquals(listOf(0, 1, 2, 3), longestIncreasingSubSequence(listOf(-0, 0, 1, 2, 3)))
    }
